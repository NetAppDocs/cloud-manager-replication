...
+
* link:task-manage-fsx-aws.html[Create an Amazon FSx for ONTAP working environment]
* link:task-deploying-otc-aws.html[Launch Cloud Volumes ONTAP in AWS]
* link:task-deploying-otc-azure.html[Launch Cloud Volumes ONTAP in Azure]
* link:task-deploying-gcp.html[Launch Cloud Volumes ONTAP in GCP]
* link:task-adding-ontap-cloud.html[Add existing Cloud Volumes ONTAP systems]
* link:task-discovering-ontap.html[Discover ONTAP clusters]
